...
This class is a state machine that transitions between states based on pair
    ...
    During these possible states HandGestureProcessor collects the required amount of evidence
    before committing to a definite state.
*/
...
extension CGPoint {
    static func midPoint(pt1: CGPoint, pt2: CGPoint) -> CGPoint {
