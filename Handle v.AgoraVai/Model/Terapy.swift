...
let terapies:[Terapy] = [
    ...
    Terapy(text: "and feel, for a few seconds, what it's like to make that gesture.", timetoDisplay: 3),
    Terapy(text: "How much space did you leave between your hands…", timetoDisplay: 3),
    Terapy(text: "Slowly, stretch your palms as if you want to expand outward", timetoDisplay: 3),
    Terapy(text: "making a small tension in the palms, feel the effect of this", timetoDisplay: 3),
    Terapy(text: "Also, noticing if doing this you feel any change in your body", timetoDisplay: 3),
    Terapy(text: "and what's like to have your hands a little more tense", timetoDisplay: 3),
    Terapy(text: "again, stretch the palms a little more letting the fingers follow them, opening a little more, increasing the space between the fingers", timetoDisplay: 3),
    Terapy(text: "and feeling the effect of it on you.", timetoDisplay: 3),
    Terapy(text: "How is the experience of having your hands outstretched…", timetoDisplay: 3),
    Terapy(text: "what happens in the head, face, eyes, neck, throat, chest, belly, legs and feet...", timetoDisplay: 3),
    Terapy(text: "Something else in your body that intends?", timetoDisplay: 3),
    Terapy(text: "If isn’t an uncomfortable degree, increase the tension in the palms again by stretching the fingers further forward and outward,including the thumbs", timetoDisplay: 3),
    Terapy(text: "and feel the effect of that behavior, that gesture on you.", timetoDisplay: 3),
    Terapy(text: "If something follows the tension of the hands, making the same movement of tension and expansion, or doing the opposite movement,of contraction…", timetoDisplay: 3),
    Terapy(text: "How far are your arms from your body?", timetoDisplay: 3),
    Terapy(text: "Are your arms glued together or too far away from your body? Is there a distance between the arm and the body?", timetoDisplay: 3),
    Terapy(text: "Keep the tension degree, do not undo.", timetoDisplay: 3),
    Terapy(text: "Let this experience register for you.", timetoDisplay: 3),
    Terapy(text: "Body and emotional experience…", timetoDisplay: 3),
    Terapy(text: "Slowly take a small step out of the tension in your palms and fingers and wait…", timetoDisplay: 3),
    Terapy(text: "Wait feeling the difference… ", timetoDisplay: 3),
    Terapy(text: "Feeling what happens inside you, in your heart, in the breath on your face, in your head, in your jaw, in your arms and hands, in your legs and feet...", timetoDisplay: 3),
    Terapy(text: "And, when you can, slowly release some more tension in your hands, in small steps…", timetoDisplay: 3),
    Terapy(text: "and wait again, feeling your answers, feeling what happens in the hands, if there is a tingling, a flow, a wave... what happens in the feet, in the head, inside the body...", timetoDisplay: 3),
    Terapy(text: "How is the space between the hands, how is the space between the arms and the body...", timetoDisplay: 3),
    Terapy(text: "If you want to make a small adjustment to the space between your hands or between your arms and your body you can.", timetoDisplay: 3),
    Terapy(text: "and slowly, again, release a little more of tension keeping the hands still facing eatch other, but with minimal tension, very gently,", timetoDisplay: 3),
    Terapy(text: "and feel the effect of it.", timetoDisplay: 3),
    Terapy(text: "feel the effect on your hands, on your body as a whole,", timetoDisplay: 3),
    Terapy(text: "feel the effect on your emotional experience, on your breathing, on your inner spaces... its general condition.", timetoDisplay: 3),
    Terapy(text: "Calmly, organizing your hands keeping the cupped hand gesture, the pose on the legs making the outline of your personal space.", timetoDisplay: 3),
    Terapy(text: "Receive your sensations, your emotional experience, your thoughts...", timetoDisplay: 3),
    Terapy(text: "notice what you have learned in this coming and going and choose if you want to repeat the exercise one more time", timetoDisplay: 3),
    Terapy(text: "and see how you can influence your degrees of tension.", timetoDisplay: 3)
]
